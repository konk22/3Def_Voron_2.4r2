...
## На этом установка Klipper и всех вспомогательных пакетов завершена. Переходим к установке CanBoot и прошивке MCU:  
...
* Устанавливаем Pyserial:
  ...
  ```
* Компилируем прошивку для CanBoot:
  ```
  cd CanBoot
	make menuconfig
  ```
